        ...
        <nav class="navbar navbar-expand-lg header-nav p-0">
            <div class="navbar-header">
                ...
                <a href="{{route('index')}}" class="navbar-brand logo">
                    <img src="{{asset('assets/frontend/img/logo.svg')}}" class="img-fluid" alt="Logo">
                </a>
            </div>
            ...
            <ul class="nav header-navbar-rht reg-head">
                <li><a href="register.html" class="reg-btn"><img src="{{asset('assets/frontend/img/icon/users.svg')}}"
                            class="me-1" alt="img">Register</a></li>
                <li><a href="login.html" class="log-btn"><img src="{{asset('assets/frontend/img/icon/lock.svg')}}" class="me-1"
                            alt="img"> Login</a></li>
