        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-4 col-lg-5">
                <div class="banner-img aos" data-aos="zoom-in" data-aos-duration="3000">
                    <img src="{{asset('assets/frontend/img/banner-img.svg')}}" class="img-fluid" alt="banner">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12 aos" data-aos="zoom-in" data-aos-duration="1000">
                    <div class="popular-catergories">
                        <div class="popular-catergories-img">
                            <span><img src="{{asset('assets/frontend/img/icon/categories1.svg')}}" alt="img"></span>
                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-12 aos" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="popular-catergories">
                        <div class="popular-catergories-img">
                            <span><img src="{{asset('assets/frontend/img/icon/categories7.svg')}}" alt="img"></span>
                        </div>
                        <div class="popular-catergories-content">
                ...
                <div class="col-lg-3 col-md-6 col-12 aos" data-aos="zoom-in" data-aos-duration="2000">
                    <div class="popular-catergories">
                        <div class="popular-catergories-img">
                            <span><img src="{{asset('assets/frontend/img/icon/categories3.svg')}}" alt="img"></span>
                        </div>
                        <div class="popular-catergories-content">
                ...
                <div class="col-lg-3 col-md-6 col-12 aos" data-aos="zoom-in" data-aos-duration="2500">
                    <div class="popular-catergories">
                        <div class="popular-catergories-img">
                            <span><img src="{{asset('assets/frontend/img/icon/categories4.svg')}}" alt="img"></span>
                        </div>
                        <div class="popular-catergories-content">
                ...
                <div class="col-lg-3 col-md-6 col-12 aos" data-aos="zoom-in" data-aos-duration="1000">
                    <div class="popular-catergories">
                        <div class="popular-catergories-img">
                            <span><img src="{{asset('assets/frontend/img/icon/categories5.svg')}}" alt="img"></span>
                        </div>
                        <div class="popular-catergories-content">
                            <h5>Music & Video</h5>
                ...
                <div class="col-lg-3 col-md-6 col-12 aos" data-aos="zoom-in" data-aos-duration="1500">
                    <div class="popular-catergories">
                        <div class="popular-catergories-img">
                            <span><img src="{{asset('assets/frontend/img/icon/categories6.svg')}}" alt="img"></span>
                        </div>
                        <div class="popular-catergories-content">
                ...
                <div class="col-lg-3 col-md-6 col-12 aos" data-aos="zoom-in" data-aos-duration="2000">
                    <div class="popular-catergories">
                        <div class="popular-catergories-img">
                            <span><img src="assets/img/frontend/icon/categories7.svg" alt="img"></span>
                        </div>
                        <div class="popular-catergories-content">
                ...
                <div class="col-lg-3 col-md-6 col-12 aos" data-aos="zoom-in" data-aos-duration="2500">
                    <div class="popular-catergories">
                        <div class="popular-catergories-img">
                            <span><img src="{{asset('assets/frontend/img/icon/categories8.svg')}}" alt="img"></span>
                        </div>
                        <div class="popular-catergories-content">
